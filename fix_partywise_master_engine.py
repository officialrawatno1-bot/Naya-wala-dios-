...
print("==========================================================================")
print("🧠 [1000 IQ FIX] WRITING DWARIKA DUAL-PARSER WITH FIXED-TAIL REGEX & AUTO-MONTH...")
print("==========================================================================")

# 1. Update dwarikaRetailerParser.ts with Strict 5-Column Tail Regex
...
// 🌟 STRICT 5-COLUMN MARG ERP DATA ROW REGEX
// Format: <NAME> <QTY> <FREE> <RATE> <AMOUNT> <PERCENT>
...
export async function parseDwarikaRetailerPdf(file: File): Promise<{ records: RetailerSaleRecord[]; detectedMonthCode?: string }> {
  ...
  for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
    ...
    for (const lineItems of lineBins) {
      ...
      // 1. Detect Month & Format from PDF Headers
      ...
      // =========================================================================
      // CASE B: LINE IS A DATA ROW (Matched 5-column tail)
      // =========================================================================
      ...
      // 1. If Report is ITEM_WISE: textCol is Retailer Name
      ...
      // 2. If Report is PARTY_WISE: textCol is Product Name
...
# 2. Update PartywiseAggregatorVault.tsx with Input Clean & Auto-Month Switch
...
export const PartywiseAggregatorVault: React.FC<Props> = ({ onBack }) => {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      // Auto-switch month if detected from PDF header
...
print("\n==========================================================================")
print("📦 [2/3] COMPILING FRONTEND (npm run build)...")
print("==========================================================================")
subprocess.run(["npm", "run", "build"], check=True)
print("✅ Build Successful.")

print("\n==========================================================================")
print("☁️ [3/3] DEPLOYING LIVE TO CLOUDFLARE PAGES...")
print("==========================================================================")
...
print("\n🎉 ALL DONE! Hard Reset & Universal Dual Parser Deployed to Cloudflare!")
